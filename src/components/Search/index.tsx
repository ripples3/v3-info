...
const OptionButton = styled.div<{ enabled: boolean }>`
    ...
    align-items: center;
    background-color: ${({ theme, enabled }) => (enabled ? theme.bg3 : 'transparent')};
    color: ${({ theme, enabled }) => (enabled ? theme.white : theme.bg3)};
    :hover {
        opacity: 0.6;
        cursor: pointer;
    }
                    ...
                    <AutoColumn gap="lg">
                        ...
                        {tokensForList
                            ...
                            .map((t, i) => {
                                return (
                                    <HoverRowLink
                                        onClick={() => handleNav(networkPrefix(activeNetwork) + 'tokens/' + t.address)}
                                        key={i}
                                    >
                                        <ResponsiveGrid>
                                            <RowFixed>
                                            ...
                                            <HideSmall>
                                                <TYPE.label textAlign="end">
                                                    {formatDollarAmount(t.volumeUSD)}
                                                </TYPE.label>
                                            </HideSmall>
                                            <HideSmall>
                                ...
                                return (
                                    ...
                                    >
                                        <ResponsivePoolGrid key={i}>
                                            ...
                                            <HideSmall>
                                                <TYPE.label textAlign="end">
                                                    {formatDollarAmount(p.volumeUSD)}
                                                </TYPE.label>
                                            </HideSmall>
                                            <HideSmall>
