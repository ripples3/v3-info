        ...
        <Wrapper minHeight={minHeight} {...rest}>
            ...
            <ResponsiveContainer width="100%" height="100%">
                ...
                >
                    <defs>
                        {colorSet.map((el) => 
                        <linearGradient key={el + colorSet.indexOf(el)} id={el} x1="0" y1="0" x2="0" y2="1">
                            <stop offset="5%" stopColor={darken(0.36, el)} stopOpacity={0.5} />
                    ...
                    />
                   { tokenSet.map((el) => 
                    <Area key={el} stackId="1" dataKey={el} type="monotone" stroke={colorSet[tokenSet.indexOf(el)]} fill={"url(#" + colorSet[tokenSet.indexOf(el)] + ")"} strokeWidth={2} />
                    )}
                </AreaChart>
            </ResponsiveContainer>
            <RowBetween>
