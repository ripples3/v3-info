...
export default function IncentivePoolTable({ poolDatas, maxItems = MAX_ITEMS }: { poolDatas: PoolData[]; maxItems?: number }) {
    // theming
    const theme = useTheme();

    //TODO: Pool sorting for weighted and metaStable and then referencing it with incentives json:
    //poolData.poolType !== ("Weighted" || "MetaStable")
    poolDatas = poolDatas.filter(poolData => poolData.poolType === ("Weighted" || "MetaStable"));
                ...
                <AutoColumn gap="16px">
                    <ResponsiveGrid>
                        ...
                        <ClickableText color={theme.text2} end={1} onClick={() => handleSort(SORT_FIELD.tvlUSD)}>
                            Week XY {arrow(SORT_FIELD.tvlUSD)}
                        </ClickableText>
                        <ClickableText color={theme.text2} end={1} onClick={() => handleSort(SORT_FIELD.volumeUSD)}>
                            Week X{arrow(SORT_FIELD.volumeUSD)}
                        </ClickableText>
                        <ClickableText color={theme.text2} end={1} onClick={() => handleSort(SORT_FIELD.volumeUSDWeek)}>
                            Week Z{arrow(SORT_FIELD.volumeUSDWeek)}
                        </ClickableText>
                    </ResponsiveGrid>
                    <Break />
